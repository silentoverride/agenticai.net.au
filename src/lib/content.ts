...
export const useCases = [
  'Manual reporting and analytics packs',
  'Slow enquiry response',
  'Repeated customer or buyer questions',
  'New client onboarding setup',
  'Scheduling and team coordination',
  'Marketing content production',
  'Document-heavy admin',
  'Owner-led decisions that should be delegated'
];
...
export const processSteps = [
  ...
  {
    title: 'Analyse',
    text: 'The transcript is reviewed for pain points, repeated work, missing systems, tool gaps, and opportunities with practical AI or automation fit.'
  },
  {
    title: 'Prioritise',
    text: 'Recommendations are ranked by effort, impact, cost, and speed to value so the highest-return quick wins are obvious.'
  },
  {
    title: 'Report',
...
export const metrics = [
  { value: '$1,200 AUD', label: 'assessment fee' },
  { value: '20-30 min', label: 'assessment intake' },
  { value: '48 hrs', label: 'report turnaround' },
  { value: '5-50', label: 'employee teams served best' }
];
...
export const upsells = [
  {
    ...
    text: 'Simplify the workflow before automation so the business is not paying to automate wasted steps.'
  },
  {
    title: 'Automation build',
    text: 'Connect apps, forms, CRMs, documents, dashboards, and task systems into dependable workflows.'
  },
  {
