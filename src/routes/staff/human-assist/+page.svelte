<script lang="ts">
  ...
  async function fetchQueue() {
    ...
    error = '';
    try {
      const url = `/api/staff/human-assist${filterStatus !== 'all' ? `?status=${filterStatus}` : ''}`;
...
<div class="ha-page">
  <header class="page-header">
    <div class="header-top">
      <div>
        ...
        <p>Assessments flagged by gates for staff review</p>
      </div>
  ...
  {:else}
    <div class="queue-list" in:fade>
      {#each queue as item}
        <a href="/staff/human-assist/{item.id}" class="queue-card">
          <div class="qc-top">
            <div class="qc-meta">
